...
<head>
    ...
    <title>Letter Sounds · Quran with FAI</title>
...
<div class="page">
    ...
    <div class="top">
        ...
        <div class="level">LEVEL 2 · LETTER SOUNDS</div>
    </div>
    ...
    <div class="instruction">
        <h2>Listen · Match · Recognise</h2>
        <p>Listen to the sound, then choose the correct Hijaiyah letter.</p>
    </div>

    <div class="sound-challenge">
        ...
        <p id="questionProgress">Question 1 of 5</p>
...
<div class="completion-overlay" id="completionOverlay">
        <div class="completion-card">
            ...
            <h2>MashaAllah!</h2>
            <p>You completed the Letter Sounds lesson.</p>

            <div class="reward-box">
                <span>⭐</span>
                <div>
                    <strong id="rewardHasana">+15 Hasana</strong>
...
<script>
    const letters = [
        {
            letter: 'ا',
            audio: '{{ asset("audio/quran-fai/level-1/pronunciation/alif.wav") }}'
        },
        {
            letter: 'ب',
            audio: '{{ asset("audio/quran-fai/level-1/pronunciation/ba.wav") }}'
        },
        {
            letter: 'ت',
            audio: '{{ asset("audio/quran-fai/level-1/pronunciation/ta.wav") }}'
        },
        {
            letter: 'ث',
            audio: '{{ asset("audio/quran-fai/level-1/pronunciation/tha.wav") }}'
        },
        {
            letter: 'ج',
            audio: '{{ asset("audio/quran-fai/level-1/pronunciation/jim.wav") }}'
        }
    ];
    ...
    function playCurrentSound(){
        ...
        audio.play().catch(() => {
            matchFeedback.textContent = 'Audio could not be played.';
            matchFeedback.className = 'match-feedback wrong';
        });
    }
    ...
    function renderQuestion(){
        ...
        const wrongChoices = shuffle(
            letters.filter(item => item.letter !== current.letter)
        ).slice(0, 3);
    ...
    function completeLevel(){
        const rewardKey = 'quran_fai_level2_rewarded';
        ...
        if (!localStorage.getItem(rewardKey)) {
            ...
            localStorage.setItem(hasanaKey, currentHasana + 15);
            localStorage.setItem(rewardKey, '1');

            rewardHasana.textContent = '+15 Hasana';
